...
const siteDefaults = {
  ...
  url: "https://www.mufatmuhendislik.com",
  founded: 2002,
  mapEmbedUrl:
    "https://www.google.com/maps?q=Cumhuriyet+Cad.+No:1,+Turhal,+Tokat&output=embed",
  socials: {
    instagram: "https://www.instagram.com/mufatmuhendislik",
...
export const team: TeamMember[] = [
  { name: "Ahmet Murat Doğan", role: "İnşaat Mühendisi" },
  { name: "Mahmut Hamza Doğan", role: "İç Mimar" },
...
export const projectFilters = ["Tümü", "Konut", "Ticari", "Endüstriyel", "Güçlendirme"];

export const projects: Project[] = [
  { slug: "kervan-konaklari", title: "Kervan Konakları", location: "Turhal, Tokat", type: "Konut", year: 2025, area: "8.400 m²",
    services: ["Statik Proje", "Yapı Denetim"],
    cover: "/images/projects/kervan-konaklari.svg",
    gallery: ["/images/projects/kervan-konaklari.svg", "/images/projects/cover-konut.svg"],
    summary: "42 daireli, TBDY 2018'e göre tasarlanmış modern konut sitesi.",
    body: "Turhal merkezde konumlanan Kervan Konakları, iki blok ve 42 daireden oluşuyor. Zemin etüdü verilerine göre radye temel tercih edildi; perde oranı optimize edilerek hem deprem güvenliği hem daire içi net alan maksimize edildi. Kaba inşaat boyunca haftalık kontrollük yapıldı ve tüm beton dökümlerinde numune takibi belgelendi." },
  { slug: "tokat-osb-uretim-tesisi", title: "OSB Üretim Tesisi", location: "Tokat OSB", type: "Endüstriyel", year: 2024, area: "12.600 m²",
    services: ["Çelik Konstrüksiyon", "Kontrollük"],
    cover: "/images/projects/tokat-osb.svg",
    gallery: ["/images/projects/tokat-osb.svg", "/images/projects/cover-endustriyel.svg"],
    summary: "24 metre açıklıklı, vinç yüklü çelik üretim tesisi.",
    body: "Tesis, 24 m serbest açıklık ve 10 tonluk gezer vinç yükü için tasarlandı. Çerçeve sistemde değişken kesitli kaynaklı profiller kullanılarak çelik tonajı %14 azaltıldı. İmalat resimleri atölye ile koordineli hazırlandı; montaj 11 haftada tamamlandı." },
  { slug: "meydan-carsi", title: "Meydan Çarşı & Ofis", location: "Amasya", type: "Ticari", year: 2024, area: "5.200 m²",
    services: ["Statik Proje", "Ruhsat Danışmanlığı"],
    cover: "/images/projects/meydan-carsi.svg",
    gallery: ["/images/projects/meydan-carsi.svg", "/images/projects/cover-ticari.svg"],
    summary: "Zemin katta çarşı, üst katlarda ofis: karma kullanımlı yapı.",
    body: "Karma kullanım nedeniyle zemin katta geniş açıklık talep edildi. Kirişli plak yerine guseli çözüm ve stratejik perde yerleşimiyle hem mimari esneklik hem düzensizlik kontrolü sağlandı. Ruhsat süreci 6 haftada sonuçlandırıldı." },
  { slug: "cumhuriyet-okulu-guclendirme", title: "Cumhuriyet Okulu Güçlendirme", location: "Zile, Tokat", type: "Güçlendirme", year: 2023, area: "3.100 m²",
    services: ["Performans Analizi", "Güçlendirme Projesi"],
    cover: "/images/projects/cumhuriyet-okulu.svg",
    gallery: ["/images/projects/cumhuriyet-okulu.svg", "/images/projects/cover-guclendirme.svg"],
    summary: "1988 yapımı okul binasının analizi ve mantolama ile güçlendirilmesi.",
    body: "Karot ve donatı tespiti sonrası yapılan performans analizi, binanın 'Göçme Öncesi' seviyede olduğunu gösterdi. Betonarme mantolama ve yeni perdelerle yapı 'Kontrollü Hasar' hedefine taşındı; okul bir eğitim yılı kaybetmeden teslim edildi." },
  { slug: "yesilirmak-villalari", title: "Yeşilırmak Villaları", location: "Turhal, Tokat", type: "Konut", year: 2023, area: "2.900 m²",
    services: ["Statik Proje", "İnşaat Danışmanlığı"],
    cover: "/images/projects/yesilirmak-villalari.svg",
    gallery: ["/images/projects/yesilirmak-villalari.svg", "/images/projects/cover-konut.svg"],
    summary: "Nehir kenarında 8 adet ikiz villa; zemin iyileştirmeli temel çözümü.",
    body: "Yüksek yeraltı su seviyesi nedeniyle jet grout ile zemin iyileştirmesi ve su yalıtımlı radye temel uygulandı. İşveren adına müteahhit hakedişleri aylık olarak denetlendi." },
  { slug: "anadolu-depo-lojistik", title: "Anadolu Lojistik Deposu", location: "Sivas", type: "Endüstriyel", year: 2022, area: "9.800 m²",
    services: ["Çelik Konstrüksiyon"],
    cover: "/images/projects/anadolu-depo.svg",
    gallery: ["/images/projects/anadolu-depo.svg", "/images/projects/cover-endustriyel.svg"],
    summary: "Kar yükü kritik bölgede ekonomik çelik depo yapısı.",
    body: "Sivas'ın kar yükü değerleri için aşık ve çapraz sistemleri optimize edildi. Tasarım, işverenin ileride 4.000 m² ek depo yapabilmesine imkân verecek şekilde genişlemeye hazır kurgulandı." },
];
...
export const posts: Post[] = [
  { slug: "tbdy-2018-ev-sahipleri-icin-ne-anlama-geliyor", title: "TBDY 2018: Ev Sahipleri İçin Ne Anlama Geliyor?",
    ...
    category: "Deprem Güvenliği", date: "2026-05-14", readMin: 6,
  ...
  { slug: "celik-mi-betonarme-mi", title: "Çelik mi, Betonarme mi? Doğru Taşıyıcı Sistemi Seçmek",
    ...
    category: "Yapı Sistemleri", date: "2026-03-02", readMin: 8,
    cover: "/images/blog/celik-betonarme.svg",
    body: [
  ...
  { slug: "yapi-ruhsati-sureci-adim-adim", title: "Yapı Ruhsatı Süreci: Adım Adım Turhal / Tokat Rehberi",
    ...
    category: "Ruhsat & Mevzuat", date: "2026-01-20", readMin: 5,
    cover: "/images/blog/ruhsat.svg",
    body: [
  ...
  { slug: "deprem-performans-analizi-nedir", title: "Deprem Performans Analizi Nedir, Ne Zaman Yaptırılmalı?",
    ...
    category: "Deprem Güvenliği", date: "2025-11-08", readMin: 7,
    cover: "/images/blog/performans.svg",
    body: [
