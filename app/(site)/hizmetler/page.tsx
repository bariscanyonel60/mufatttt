  ...
  return (
    <>
      <PageHeroMedia
        ...
        title="On iki disiplin. Tek sorumluluk."
        lead="Projeden taahhüde; plan, yapım, kontrollük ve belgelendirme tek çatı altında."
        image="/images/services-banner.png"
        imageAlt="MUFAT İnşaat Mühendislik hizmetleri"
        imagePosition="center top"
      />

      <section className="container-x space-y-5 py-20 md:py-28">
        {services.map((s, i) => (
          <Reveal key={s.slug} delay={0.04}>
            <article
              id={s.slug}
              className="card group grid gap-6 p-7 transition duration-500 hover:border-gold/30 md:grid-cols-[64px_1fr_1.35fr] md:items-start md:gap-10 md:p-9"
            >
              ...
              <div>
                ...
                <h2 className="mt-1 font-display text-2xl font-bold">
                  <a href={`/hizmetler/${s.slug}`} className="transition hover:text-gold-deep">
                    {s.title}
                  </a>
                </h2>
